...
function(e) {
	...
	o.modules = {}, o.status = {}, o.timeout = 10, o.event = {}, t.fn.define = function(e, t) {
		...
		var s = (i || e).replace(/\.|\//g, ""),
			c = l.id = "layuicss-" + s,
			f = 0;
		l.rel = "stylesheet", l.href = e + (o.debug ? "?v=" + (new Date).getTime() : ""), l.media = "all", n.getElementById(c) || a.appendChild(l), "function" == typeof t && !
		function d() {
...
layui.define("jquery", function(e) {
	...
	i.prototype.init = function(e) {
		...
		layui.each(n, function(a, n) {
			var l = n.children && n.children.length > 0,
				...
				s = o(["<li " + (n.spread ? 'data-spread="' + n.spread + '"' : "") + ">", function() {
					...
					return '<a href="' + (n.href || "javascript:;") + '" ' + (i.target && n.href ? 'target="' + i.target + '"' : "") + ">" + ('<i class="layui-icon layui-tree-' + (l ? "branch" : "leaf") + '">' + (l ? n.spread ? t.branch[1] : t.branch[0] : t.leaf) + "</i>") + ("<cite name='" + n.name + "'>" + (n.name || "未命名") + "</cite></a>")
				}(), "</li>"].join(""));
		...
		var a = this,
			r = a.options;
			var ele=$(a.options.ele);

		e.children("a").on("click", function(e) {
			ele.find('cite').parent().removeClass('current');
			ele.find('cite[name="'+o.name+'"]').parent().addClass('current');
